...
SRC_URI="http://www.hamrick.com/files/vuex32${MY_PV}.tgz -> ${P}.tgz
...
src_install() {
	...
	insinto /opt/vuescan
	doins vuescan.ds vuescan.8ba *htm lan_*
	if use doc; then
...
pkg_postinst() {
	...
	einfo ""
	einfo "To register Vuesca 9.0.91 use follow information:"
	einfo "E-mail address  : strallmate@gmail.com" 
	einfo "Serial number   :  110751460"
	einfo "Customer number :   57505489"
}
