...
SRC_URI="amd64? ( http://solutions.brother.com/Library/sol/printer/linux/dlf/brscan2-${PV}-4.x86_64.rpm )
		 x86? ( http://solutions.brother.com/Library/sol/printer/linux/dlf/brscan2-${PV}-4.i386.rpm )"
LICENSE="GPL-2"
SLOT="0"
IUSE=""
