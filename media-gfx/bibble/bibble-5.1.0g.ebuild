...
BUILD="${PV//\./}-20100729"
SRC_URI="http://edge.bibblelabs.com/${BUILD}/${PN}5-${PV}_i386.deb"

LICENSE="bibblepro"
SLOT="5"
KEYWORDS="~x86 ~amd64"
IUSE="brenda +qt-bundled"
...
PDEPEND="brenda? ( media-plugins/bibble-plugins-brenda )"
