...
AWCOMMON_RPM="AWCommon-9.5-1.i686.rpm"
AWCOMMON_SERVER_RPM="AWCommon-server-9.5-1.i686.rpm"
MAYA_RPM="Maya7_0-7.0-374.i686.rpm"
MAYA_DOCS_RPM="Maya7_0-docs_en_US-7.0-380.i686.rpm"
MAYA_DOCS_SERVER="Maya7_0-docserver-7.0-380.i686.rpm"
...
CDROM_NAME_1="Maya 7 Installation CD"
...
src_unpack() {
	...
	if use doc ; then
		...
		rpm_unpack ${CDROM_ROOT}/${MAYA_DOCS_SERVER} || die
		
		if ! use bundled-libs; then
			rm -rf ${S}/usr/aw/maya7.0/docs/jre || die
			sed -i -e 's:JAVACMD=\./jre/bin/java:JAVACMD=java:g' ${S}/usr/aw/maya7.0/docs/startDocServer.sh || die
		fi
	fi
...
src_install() {
	...
	dosym maya7.0 ${AWDIR}/maya

	# The RPM puts these in /usr/local/bin
	dosym ${MAYADIR}/bin/Maya7.0 ${MAYADIR}/bin/maya
...
#	fi
	...
	make_desktop_entry maya "Maya 7" /usr/aw/maya/icons/mayaIcon.xpm
}
