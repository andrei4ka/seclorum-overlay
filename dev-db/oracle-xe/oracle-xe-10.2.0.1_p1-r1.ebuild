...
inherit eutils rpm check-reqs wtk-enterprise

IUSE="hardened unicode"
...
SRC_URI="unicode? ( ${PN}-univ-${MY_PV}.i386.rpm )
		!unicode? ( ${MY_P}.rpm )"
...
pkg_nofetch() {
	...
	eerror ""
	eerror "After downloading it, put the ${PN}-univ-${MY_PV}.i386.rpm "
	eerror "  or ${MY_P}.rpm into: ${DISTDIR}"
	eerror ""
}
