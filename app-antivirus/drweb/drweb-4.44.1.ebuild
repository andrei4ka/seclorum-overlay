...
SRC_URI="ftp://ftp.drweb.com/pub/drweb/unix/Linux/Generic/${P}-${MY_GLIBC}.tar.bz2
	...
	doc? ( ftp://ftp.drweb.com/pub/drweb/unix/doc/${PN}-433-unix-en-pdf.zip )
	 X? ( ftp://ftp.drweb.com/pub/drweb/unix/Linux/Generic/${PN}-x-${PV}-${MY_GLIBC}.tar.bz2 )"
