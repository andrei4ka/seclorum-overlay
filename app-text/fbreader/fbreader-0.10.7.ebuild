...
# $Header: /var/cvsroot/gentoo-x86/app-text/fbreader/fbreader-0.10.7.ebuild,v 1.1 2009/04/04 10:06:38 alexxy Exp $
...
src_install() {
	...
	doins ${FILESDIR}/x-fb2.desktop
	insinto /usr/share/applications/
	doins ${FILESDIR}/fbreader.desktop
	dosym /usr/bin/FBReader /usr/bin/fbreader
}
