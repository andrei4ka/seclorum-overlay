...
SRC_URI="http://www.netams.com/files/${P}c.tar.gz"
SLOT="0"
LICENSE="GPL-2"
KEYWORDS="~x86 ~amd64"
...
src_unpack() {
	...
	epatch ${FILESDIR}/${PV}/netams-admin-3.4.2.patch
	epatch ${FILESDIR}/${PV}/netams-doc-3.4.2.patch
	epatch ${FILESDIR}/${PV}/netams-html_fix-3.4.2.patch
	epatch ${FILESDIR}/${PV}/netams-Makefile-3.4.2.patch
	epatch ${FILESDIR}/${PV}/netams-schedule_fix.patch
	epatch ${FILESDIR}/${PV}/netams-src-3.4.2.patch
