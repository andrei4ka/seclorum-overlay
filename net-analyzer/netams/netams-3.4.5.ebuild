...
src_unpack() {
	unpack ${A} ; cd ${S}
	epatch ${FILESDIR}/3.4.2/netams-admin-3.4.2.patch
#	epatch ${FILESDIR}/3.4.2/netams-configure_glib-3.4.5.patch
	epatch ${FILESDIR}/3.4.2/netams-doc-3.4.2.patch
	epatch ${FILESDIR}/3.4.2/netams-html_fix-3.4.2.patch
	epatch ${FILESDIR}/3.4.2/netams-image_fix2-3.4.5.patch
	epatch ${FILESDIR}/3.4.2/netams-image_fix-3.4.3.patch
	epatch ${FILESDIR}/3.4.2/netams-Makefile-3.4.2.patch
	epatch ${FILESDIR}/3.4.2/netams-schedule_fix.patch
	epatch ${FILESDIR}/3.4.2/netams-src-3.4.2.patch

	if use amd64 ; then
		epatch ${FILESDIR}/3.4.2/netams-x86-64.patch
		epatch ${FILESDIR}/3.4.2/netams-configure_glib-3.4.5.patch
	fi
