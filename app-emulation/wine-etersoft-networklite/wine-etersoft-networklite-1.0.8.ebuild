...
MY_P="wine-etersoft-networklite-${PV}"
DESCRIPTION="WINE@Etersoft Network-Lite, a addon for WINE@Etersoft with enhanced Network support for office application, as such as 1C:Predpryatie"
HOMEPAGE="http://www.etersoft.ru/"
SRC_URI="${MY_P}.tbz2"

LICENSE="WINE@Etersoft-Network-lite Corp.WINE@Etersoft-Network"
SLOT="0"
KEYWORDS="-* ~x86 ~amd64"
